...
🎯 Objective
Analyze the website https://www.iplt20.com using SecurityHeaders.com and OWASP ZAP to identify missing headers, vulnerabilities, and generate a security report.
🛠 Tools Used
SecurityHeaders.com
OWASP ZAP 2.17.0
